...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
    ...
    <ul class="nav nav-pills nav-stacked" style="border-right:1px solid black">
        ...
        <li>
            <a href="homeSecretaire.php" data-toggle="collapse" data-target="#submenu-0"><i class="fa fa-dashboard"></i> Tableau de bord</a>
        </li>


        <li>
            <a href="afficherAFF.php" data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-check-circle"></i> Affectation </a>
        </li>
        <li>
            <a href="" data-toggle="collapse" data-target="#submenu-2"><span class="fa fa-university"></span> Soutenance </a>
