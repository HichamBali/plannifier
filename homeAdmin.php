  ...
  <body>
    ...
    <div class="navbar-nav navbar-inverse navbar-fixed-top">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html"><img src="images/plan.png" id="plan"> </a>
        </div> 
        <!--:
      ...
      <!-- USER PROFILE BLOCK -->
        <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit">
	      		...
	      		<hr>
				<div class="thumbnail">
					<img src="images/student.png" alt="Marcel Newman" class="img-circle">
				</div><!-- /thumbnail -->
				<h1>Fandi Amina</h1>
				<h3>Master 2 - Genie Logiciel -</h3>
				<br>
					<div class="info-user">
						<a href="user.html"><span aria-hidden="true" class="li_user fs1" ></span></a>
...
<div class="dash-unit">
	<dtitle>Consulter Planning</dtitle>
      	<a href="file:///C:/Users/pc/Desktop/plan&go_theme/user.html" style="display:block;width:100%;height:100%;">PLANNING</a>
