...
<div class="navbar-nav navbar-inverse navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-collapse my-2 my-lg-0">
            ...
            <a href="logOut.php" class="navbar-brand pull-right"><strong>Déconnexion</strong></a>
            <!-- <li class="active"><a href="logOut.php"><i class="icon-home icon-white"></i> Déconnexion</a></li>-->
        </div>  <!--/.nav-collapse -->
    </div>
</div>
